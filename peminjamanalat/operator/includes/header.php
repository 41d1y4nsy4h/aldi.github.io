 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
   <ul class="navbar-nav">
    ...
    <!-- <li class="nav-item">
     <a class="nav-link" href="../operator/data-barang.php">Data Alat Pengajar</a>
    </li> -->
    <li class="nav-item">
     <a class="nav-link" href="../operator/index.php">Peminjaman Alat</a>
    </li>
    <li class="nav-item">
     <a class="nav-link" href="../operator/data-peminjaman.php">Histori Peminjaman</a>
    </li>
    <li class="nav-item">
